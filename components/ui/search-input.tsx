  ...
  return (
    <div className="relative w-full">
      ...
      <input
        ...
        className={
          className ??
          "w-full pl-10 pr-4 h-10 rounded-xl border border-[#D6DED2] bg-[#F7F8F3]/60 text-sm text-[#243028] placeholder:text-[#A8B0AA] focus:outline-none focus:ring-2 focus:ring-[#8FAF9A]/50 focus:border-[#8FAF9A] transition-all duration-200"
        }
      />
    </div>
  );
