...
export function StatCard({
  ...
  return (
    <div
      className={cn(
        "relative flex flex-col gap-2 rounded-xl border border-[#D6DED2] bg-white p-4 shadow-sm",
        className
      )}
    ...
    >
      ...
      <div className="flex items-center gap-2 text-muted-foreground">
        <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#DDE8D8]/60 text-[#4F6F52]">
          {icon}
        </span>
      ...
      <div className="flex items-end justify-between">
        <span className="text-2xl font-bold tracking-tight text-[#243028]">
          {value}
        </span>
