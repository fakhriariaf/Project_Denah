                ...
                <div className="pb-4 border-b border-border flex justify-between items-center">
                  <div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mt-2">
                      ...
                      {unit.readyStockSource === "legacy_ready_stock" && <span className="bg-[#F4F6F0] text-[#606C5A] border border-primary/20 text-[10px] font-extrabold px-2 py-0.5 rounded-lg">🏠 Legacy Ready Stock</span>}
