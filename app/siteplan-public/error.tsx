...
export default function SiteplanPublicError({
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 text-center px-4">
      <div className="w-16 h-16 rounded-full bg-rose-50 dark:bg-rose-950/30 flex items-center justify-center text-rose-500 mb-6">
        <AlertCircle className="w-8 h-8" />
      </div>
      <h2 className="text-xl font-bold text-[#243028] dark:text-foreground mb-2">Terjadi Kesalahan</h2>
      <p className="text-sm text-[#66736A] dark:text-muted-foreground max-w-md mb-6">
