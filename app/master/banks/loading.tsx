    ...
    <div className="flex flex-col gap-6">
      ...
      <Card className="border-[#D6DED2] bg-white shadow-sage">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg text-[#243028]">Data Bank Rekanan</CardTitle>
          <CardDescription className="text-xs text-[#66736A]">Daftar bank rekanan untuk proses KPR</CardDescription>
            ...
            <Table>
              <TableHeader className="bg-muted/40">
                <TableRow className="border-[#D6DED2] hover:bg-transparent">
                  <TableHead className="font-semibold text-xs text-[#66736A]">Nama Bank</TableHead>
                  <TableHead className="font-semibold text-xs text-[#66736A]">Kode Bank</TableHead>
                  <TableHead className="font-semibold text-xs text-[#66736A]">Jenis</TableHead>
                  <TableHead className="font-semibold text-xs text-[#66736A]">Status</TableHead>
              ...
              <TableBody>
                {Array.from({ length: 5 }).map((_, rowIndex) => (
                  <TableRow key={rowIndex} className="border-[#D6DED2] hover:bg-slate-50/20">
                    ...
                    <TableCell>
                      <Skeleton className="h-4.5 w-20 bg-[#A8B0AA]/10 font-mono" />
                    </TableCell>
                    <TableCell>
                      <Skeleton className="h-4.5 w-24 bg-slate-100" />
                    </TableCell>
                    <TableCell>
                      <Skeleton className="h-5.5 w-20 bg-[#DDE8D8]/40 border border-[#8FAF9A]/10 rounded-full" />
                    </TableCell>
