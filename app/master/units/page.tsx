    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="relative rounded-2xl overflow-hidden bg-gradient-to-r from-[#DDE8D8]/70 via-white/95 to-[#DDE8D8]/40 border border-border shadow-sage p-6">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="flex items-start gap-3">
            ...
            <div>
              <h1 className="text-2xl font-black text-foreground tracking-tight"><Translate id="unit.title" /></h1>
              <p className="text-sm text-muted-foreground mt-0.5"><Translate id="unit.subtitle" /></p>
            </div>
          </div>
          {isEditor && (
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
        ...
        <Card className="bg-card border-border shadow-sage hover:shadow-sage-lg hover:-translate-y-0.5 transition-premium">
          <CardContent className="p-5 flex items-center justify-between gap-3">
            <div className="space-y-1 min-w-0">
              <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider"><Translate id="unit.total" /></p>
              <h3 className="text-2xl font-black font-mono tracking-tight text-foreground tabular-nums">{totalUnits}</h3>
              <p className="text-[10px] text-primary/70"><Translate id="unit.total_desc" /></p>
            </div>
        ...
        <Card className="bg-card border-border shadow-sage hover:shadow-sage-lg hover:-translate-y-0.5 transition-premium">
          <CardContent className="p-5 flex items-center justify-between gap-3">
            <div className="space-y-1 min-w-0">
              <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider"><Translate id="unit.available" /></p>
        ...
        <Card className="bg-card border-border shadow-sage hover:shadow-sage-lg hover:-translate-y-0.5 transition-premium">
          <CardContent className="p-5 flex items-center justify-between gap-3">
            <div className="space-y-1 min-w-0">
              <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider"><Translate id="unit.sold" /></p>
        ...
        <Card className="bg-card border-border shadow-sage hover:shadow-sage-lg hover:-translate-y-0.5 transition-premium">
          <CardContent className="p-5 flex items-center justify-between gap-3">
            <div className="space-y-1 min-w-0">
              <p className="text-[10px] text-muted-foreground font-bold uppercase tracking-wider"><Translate id="unit.construction" /></p>
              <h3 className="text-2xl font-black font-mono tracking-tight text-primary tabular-nums">{constructionCount}</h3>
              <p className="text-[10px] text-primary/70"><Translate id="unit.construction_desc" /></p>
            </div>
