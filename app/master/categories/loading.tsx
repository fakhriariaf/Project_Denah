    ...
    <div className="flex flex-col gap-6">
      ...
      <Card className="border-[#D6DED2] bg-white shadow-sage">
        <CardHeader className="pb-3">
          <CardTitle className="text-lg text-[#243028]">Data Kategori Keuangan</CardTitle>
          <CardDescription className="text-xs text-[#66736A]">Daftar kategori untuk pencatatan transaksi keuangan</CardDescription>
            ...
            <Table>
              <TableHeader className="bg-muted/40">
                <TableRow className="border-[#D6DED2] hover:bg-transparent">
                  <TableHead className="font-semibold text-xs text-[#66736A]">Nama Kategori</TableHead>
                  <TableHead className="font-semibold text-xs text-[#66736A]">Tipe</TableHead>
                  <TableHead className="font-semibold text-xs text-[#66736A]">Keterangan</TableHead>
