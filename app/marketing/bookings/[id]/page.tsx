            ...
            <div className="bg-card border border-border rounded-2xl p-5 shadow-sage">
              ...
              <div className="space-y-2">
                ...
                {bookingData.unitStatus && (() => {
                  ...
                  return (
                    <div>
                      <p className="text-[10px] font-bold uppercase tracking-wider text-primary/70">Status Unit</p>
          ...
          <div className="bg-card border border-border rounded-2xl p-5 shadow-sage">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center p-3 bg-muted/30 rounded-xl">
                <span className="text-sm font-semibold text-muted-foreground">{t("booking_detail.booking_fee")}</span>
                <span className="font-mono font-bold text-primary">{formatRupiah(bookingData.bookingFee)}</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-muted/30 rounded-xl">
                <span className="text-sm font-semibold text-muted-foreground">{t("booking_detail.down_payment")}</span>
              ...
              <div className="flex justify-between items-center p-3 bg-secondary/40 rounded-xl border border-primary/20">
                <span className="text-sm font-bold text-foreground">{t("booking_detail.total_paid")}</span>
          ...
          {bookingData.customerId && (
            <div>
              <div className="flex items-center gap-2 mb-3">
                ...
                <h3 className="font-bold text-foreground text-sm">{t("booking_detail.kpr_title")}</h3>
              </div>
